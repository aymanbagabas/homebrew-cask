cask "vimac" do
  module Utils
    ...
    def self.get(release, prop)
      base_uri = URI("https://api.appcenter.ms/v0.1/apps/dexterleng/vimac/distribution_groups/sparkle/releases/#{release}")
      JSON.parse(Net::HTTP.get(base_uri))[prop]
    end

    def self.releases
      base_uri = URI("https://api.appcenter.ms/v0.1/apps/dexterleng/vimac/distribution_groups/sparkle/public_releases")
